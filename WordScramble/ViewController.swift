...
//  WordScramble
//
//  Created by Vitor Bukovitz on 19/01/21.
//
...
class ViewController: UITableViewController {
    ...
    func submit(_ answer: String) {
        ...
        if !lowerAnswer.isEmpty {
            ...
            showErrorMessage(errorTitle: "Empty word", errorMessage: "Enter something!")
        }
    ...
    func isReal(word: String) -> Bool {
        ...
        return misspelledRange.location == NSNotFound && word.count > 2 && title.prefix(3) != word
    }
}
